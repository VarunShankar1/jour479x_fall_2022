...
This data goes from 2012 to 2021 and has an astonishing 485453 rows. There are 372 variables here that tell you much of what you need to know to explain what happened on the play. I will only be looking at quarterbacks drafted in the first three rounds of the NFL draft and can find that day myself from research to isolate those quarterbacks. 
...
```{r}
ggplot() + 
  geom_line(data=trevorlawrencedata, aes(x=game_data, y=totalyds, color="red")
```
I could not get this line graph to work, not sure why. 
